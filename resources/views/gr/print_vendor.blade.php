...
<body>
    ...
    <table class="data-table">
        <thead>
            <tr>
                <th width="5%">No</th><th width="35%">Nama Barang & Kode</th>
                <th width="10%">PO</th><th width="10%">Terima</th>
                <th width="20%">Gudang Tujuan</th><th width="20%">Kondisi / Catatan</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><strong>{{ (float)$item->purchaseOrderItem?->qty_ordered }}</strong></td>
                <td style="text-align: center;"><strong>{{ (float)$item->qty_received }}</strong></td>
                
                {{-- 🔥 INI YANG SEBELUMNYA KOSONG (-) SEKARANG PASTI TERISI 🔥 --}}
                <td style="text-align: center; color: #0056b3;"><strong>{{ $item->warehouse_name_display }}</strong></td>
    ...
    <table class="signature-table">
        <tr>
            <td><div>Diserahkan Oleh (Vendor),</div><div class="sign-space"></div><div>_______________________</div></td>
            <td><div>Diketahui Oleh (Purchasing),</div><div class="sign-space"></div><div>_______________________</div></td>
            <td><div>Diterima Oleh (Gudang),</div><div class="sign-space"></div><div>{{ $gr->receiver_name_display }}</div></td>
        </tr>
    </table>
</body>
</html>