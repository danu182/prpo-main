    ...
    <div id="items-container">
        ...
        <div class="item-card item-row" data-index="{{ $iIdx }}">
            <div class="item-card-header">
                ...
                <button type="button" class="shadow-sm btn-delete-item" onclick="removeItem(this)" title="Hapus Barang Ini">
            ...
            <div class="item-card-body">
                ...
                <div class="mt-4 shadow-sm vendor-section">
                    <div class="pb-2 mb-3 d-flex justify-content-between align-items-center border-bottom">
                        <label class="small fw-bold text-dark text-uppercase">
                            <i class="bi bi-tags-fill me-2 text-success"></i>Referensi Vendor & Penawaran
                        </label>
                    ...
                    <div class="vendor-container" id="vendor-container-{{ $iIdx }}">
                        ...
                        <div class="vendor-row">
                            ...
                            <div class="row g-3 pe-4">
                                ...
                                <div class="mt-2 col-lg-6">
                                    <label class="mb-1 x-small text-muted fw-bold">Catatan untuk Vendor</label>
                                    <input type="text" name="items[{{ $iIdx }}][vendors][0][notes]" class="form-control form-control-sm">
                                </div>
                            </div>
                        </div>
                        @endforelse
