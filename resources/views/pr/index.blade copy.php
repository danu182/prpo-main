                ...
                <table class="table mb-0 align-middle table-hover">
                    ...
                    <tbody>
                        @forelse($requests as $pr)
                            <tr>
                                <td class="py-3 ps-4">
                                    <a href="{{ route('pr.show', $pr->id) }}" class="fw-bold text-decoration-none">
                                        {{ $pr->pr_number }}
                                    </a>
                                ...
                                <td class="py-3 pe-4 text-end">
                                    <div class="btn-group">
                                        <a href="{{ route('pr.show', $pr->id) }}" class="mx-1 border shadow-sm btn btn-sm btn-light rounded-circle" title="Lihat Detail">
                                            <i class="bi bi-eye text-primary"></i>
                                        </a>

                                        @if($pr->status && $pr->status->slug == 'pending_approval')
                                            <a href="{{ route('pr.edit', $pr->id) }}" class="mx-1 border shadow-sm btn btn-sm btn-light rounded-circle" title="Edit PR">
