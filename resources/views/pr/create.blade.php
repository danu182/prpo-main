...
<form action="{{ route('pr.store') }}" method="POST" enctype="multipart/form-data" id="prForm">
    ...
    <div class="pb-3 mb-4 d-flex justify-content-between align-items-center border-bottom">
        <div>
            ...
            <p class="mb-0 text-muted small">Ajukan permintaan pengadaan barang/jasa untuk kebutuhan operasional.</p>
        </div>
        ...
        <div class="item-card item-row" data-index="0">
            <div class="item-card-header">
                <h6 class="mb-0 fw-bold text-dark">
                    <span class="px-2 py-1 shadow-sm badge bg-primary rounded-pill me-2 item-number">1</span> Rincian Barang
                </h6>
            ...
            <div class="item-card-body">
                <div class="row g-4">
                    <div class="col-md-5">
                        ...
                        <select name="items[0][item_id]" class="form-select select2-item-ajax" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="items[0][qty]" class="form-control text-primary fw-bold border-secondary-subtle" placeholder="0" min="0.01" step="0.01" required>
                    </div>
                    <div class="col-md-4">
                        <label class="mb-2 small text-dark fw-bold">Kemasan / Satuan <span class="text-danger">*</span></label>
                        <select name="items[0][uom_id]" class="form-select select-uom fw-bold border-secondary-subtle bg-light" required>
                        ...
                        <div class="vendor-row">
                            ...
                            <div class="row g-3 pe-4">
                                ...
                                <div class="mt-2 col-lg-6">
                                    ...
                                    <input type="text" name="items[0][vendors][0][notes]" class="shadow-sm form-control form-control-sm" placeholder="Contoh: Pastikan garansi resmi...">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // 🔥 LOGIKA TAMBAH BARANG (KLONING DENGAN CKEDITOR) 🔥
