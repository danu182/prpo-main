                ...
                <div class="p-4 modal-body bg-light text-start">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6 border-end pe-md-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-muted text-uppercase">Pilih Barang <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-muted">Jumlah Unit (Qty) <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-warning-subtle border-warning"><i class="bi bi-box-fill text-warning"></i></span>
                                    <input type="number" name="quantity" class="form-control border-warning fw-bold" value="1" min="1" required>
                                </div>
                                <div class="form-text small">Jika mengisi lebih dari 1, nomor seri (S/N) fisik harus diupdate manual setelah registrasi.</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 ps-md-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-muted">Serial Number (Hanya jika Qty = 1)</label>
