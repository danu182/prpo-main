        ...
        <div class="p-0 card-body table-responsive">
            <table class="table mb-0 align-middle table-hover">
                ...
                <tbody>
                    ...
                    {{-- 🔥 MODAL RIWAYAT ASET YANG SUDAH DIPERBAIKI 🔥 --}}
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                            <div class="overflow-hidden border-0 shadow-lg modal-content rounded-4">
                                ...
                                <div class="p-0 modal-body bg-light text-start">
                                    ...
                                    {{-- Info Header Aset --}}
                                    <div class="p-4 text-center bg-white border-bottom shadow-sm z-1 position-relative">
                                        ...
                                        <div class="p-4 bg-white shadow-sm timeline-container rounded-4">
                                            @forelse($ast->histories as $log)
                                                <div class="mb-4 d-flex position-relative">
                                                    <div class="mt-1 me-3 flex-shrink-0">
                                                    ...
                                                    <div class="pb-3 border-bottom w-100">
                                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                                            ...
                                                            <small class="text-muted fw-bold bg-light px-2 py-1 rounded">{{ \Carbon\Carbon::parse($log->created_at)->format('d M Y, H:i') }}</small>
                                                        </div>

                                                        @if($log->assigned_to)
                                                            <div class="mb-2 small fw-bold text-primary">
                                                                <i class="bi bi-arrow-right-short"></i> Diserahkan ke: {{ optional($log->assignee)->name }}
                                                            </div>
                                                        @elseif(in_array(strtolower($log->status), ['available', 'maintenance', 'returned']))
                                                            <div class="mb-2 small fw-bold text-success">
                                                                <i class="bi bi-arrow-left-short"></i> Gudang: {{ optional($ast->warehouse)->name ?? 'Pusat' }}
                                                            </div>
                                                        @endif

                                                        <div class="p-3 mt-2 border-start border-3 border-info rounded text-dark bg-info-subtle small" style="line-height: 1.4;">
                                            ...
                                            @empty
                                                <div class="py-5 text-center text-muted">
                                                    ...
                                                    <span class="small">Aset ini belum pernah dipindahtangankan.</span>
                                                </div>
                                            @endforelse
                                        </div>
                                    </div>
...
{{-- 🔥 MODAL TAMBAH ASET MANUAL (DENGAN AJAX SELECT2, INPUT HARGA & UPLOAD DOKUMEN) 🔥 --}}
                ...
                <div class="p-4 modal-body bg-light text-start">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6 border-end pe-md-4">
                            ...
                            {{-- 🔥 INPUT BARU UNTUK NAMA CUSTOM ASET 🔥 --}}
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-muted">Penamaan Spesifik Aset</label>
                                <input type="text" name="asset_name" class="form-control border-primary shadow-sm" placeholder="Cth: Laptop Core i7 Direksi...">
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="date" name="acquisition_date" class="form-control border-info shadow-sm" value="{{ date('Y-m-d') }}" required>
                                </div>
                                <div class="col-6 mb-3">
                                    <label class="form-label fw-bold small text-muted">Jumlah Unit <span class="text-danger">*</span></label>
                                    <input type="number" name="quantity" class="form-control border-warning shadow-sm" value="1" min="1" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 ps-md-4">
                            ...
                            {{-- 🔥 ROW MATA UANG DAN HARGA 🔥 --}}
                            <div class="row">
                                <div class="col-4 mb-3 pe-1">
                                ...
                                <div class="col-8 mb-3 ps-1">
                                    ...
                                    <input type="number" name="purchase_price" class="form-control border-success shadow-sm" placeholder="Estimasi harga hibah..." min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 ps-md-3">
                                    ...
                                    <input type="file" name="supporting_document" class="form-control shadow-sm border-secondary" accept=".pdf,.jpg,.jpeg,.png">
...
<script>
    $(document).ready(function() {
        ...
        // 🔥 SCRIPT AJAX UNTUK PENCARIAN BARANG MASTER 🔥
