                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    ...
                    <ul class="mx-auto nav nav-pills nav-pills-custom align-items-center">
                       ...
                       {{-- 4. WAREHOUSE DROPDOWN --}}
                        ...
                        <li class="nav-item dropdown">
                            {{-- 🔥 UPDATE: Tambahkan 'stock-transfers.*' ke dalam daftar indikator active 🔥 --}}
                            ...
                            <ul class="dropdown-menu">
                                ...
                                {{-- 🔥 TAMBAHAN MENU BARU: MUTASI ANTAR GUDANG 🔥 --}}
                                <li>
                        ...
                        {{-- 6. REPORT --}}
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('reports.*') ? 'active fw-bold' : '' }}" href="{{ route('reports.finance') }}">
                        ...
                        @can('manage_roles')
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ request()->routeIs('users.*', 'roles.*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                                Settings
                            </a>
                                                ...
                                                <li>
                                                    <a class="py-2 mb-1 dropdown-item rounded-3 text-wrap {{ $isRead ? 'bg-light opacity-75' : 'bg-white border-start border-primary border-3 shadow-sm' }}" href="{{ route('notif.read', $notification->id) }}">
                                                        <div class="d-flex justify-content-between align-items-start">
                                                            <div class="small {{ $isRead ? 'text-muted' : 'text-dark fw-bold' }}">{{ $notification->data['title'] }}</div>
                            ...
                            <a href="#" class="text-decoration-none d-flex align-items-center" data-bs-toggle="dropdown">
                                @if(Auth::user()->avatar)
                                    <img src="{{ asset('storage/' . Auth::user()->avatar) }}"
                                         class="shadow-sm user-avatar-small object-fit-cover" alt="Avatar">
                                @else
                                    <div class="shadow-sm user-avatar-small">
