                ...
                <div class="card-body p-4">
                    <form action="{{ route('document-types.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Cth: Retur Barang Vendor" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Namespace Model Class</label>
                            <input type="text" name="model_class" class="form-control" placeholder="Cth: App\Models\ReturnVendor" required>
