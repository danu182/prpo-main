...
<div class="py-4 container-fluid">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-end">
        ...
        <div class="gap-2 d-flex">
            ...
            {{-- Tombol Export --}}
            <a href="{{ route('reports.finance.pdf', ['start_date' => $startDate, 'end_date' => $endDate, 'status' => $statusSlug]) }}" target="_blank" class="shadow-sm btn btn-outline-danger rounded-pill fw-bold">
                <i class="bi bi-file-pdf-fill me-1"></i> Export PDF
            </a>
            {{-- Tombol Export Excel --}}
            <a href="{{ route('reports.finance.excel', ['start_date' => $startDate, 'end_date' => $endDate, 'status' => $statusSlug]) }}" class="shadow-sm btn btn-success rounded-pill fw-bold">
