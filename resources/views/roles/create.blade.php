...
<div class="container pb-5">
    ...
    <div class="border-0 shadow-sm card rounded-4">
        <div class="py-3 bg-white card-header border-bottom">
            <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-plus-circle-fill me-2 text-primary"></i>Buat Role Baru</h5>
        </div>
        <div class="p-4 card-body">
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="mb-4 w-50">
                    ...
                    <input type="text" name="name" class="form-control fw-bold" placeholder="Contoh: Staff Gudang" required>
                </div>
