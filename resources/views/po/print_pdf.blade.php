...
<body>
    ...
    {{-- 🔥 TAMBAHKAN FOOTER DI SINI (TEPAT DI BAWAH BODY) 🔥 --}}
    <footer>
            ...
            <td style="width: {{ $tdWidth }}; vertical-align: bottom;">
                ...
                <div style="height: 65px; padding-top: 5px;">
                    @if(optional($po->user)->signature)
                        <img src="{{ public_path('storage/' . $po->user->signature) }}" class="signature-img">
                    @else
                ...
                <td style="width: {{ $tdWidth }}; vertical-align: bottom;">
                    ...
                    <div style="height: 65px; padding-top: 5px;">
                        ...
                        @elseif($app->status === 'APPROVED')
                            {{-- Cek jika punya gambar TTD --}}
                            @if(optional($app->approver)->signature)
                                <img src="{{ public_path('storage/' . $app->approver->signature) }}" class="signature-img">
                            @else
